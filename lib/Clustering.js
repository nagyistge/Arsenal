...
class Clustering {
    ...
    /**
     * Function called after a stop() call
     *
     * @private
     * @return {undefined}
     */
    ...
    /**
     * Function called when a worker exited
     *
    ...
    /**
     * Function to put handler on cluster exit
     *
     * @param {function} cb - Callback when cluster exit
     * @return {Clustering} Itself
     */
    onExit(cb) {
        this._exitCb = cb;
    ...
    /**
     * Function to get the status of the cluster
     *
    ...
    /**
     * Function to return if it's the master process
     *
    ...
    /**
     * Function to get index of the worker
     *
